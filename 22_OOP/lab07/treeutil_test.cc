...
TEST(TestUtil, ToStringTest1) {
    ...
    std::string result = tree_util->ToString(&root);
    std::string answer = "IntNode(15, StringNode(good, IntNode(8, NULL, NULL), "
    "IntNode(4, NULL, NULL)), IntNode(6, StringNode(hello, NULL, NULL), "
    "StringNode(oop, NULL, NULL)))";
    EXPECT_EQ(result, answer);
}

TEST(TestUtil, ToStringTest2) {
    ...
    std::string result = tree_util->ToString(&root);
    std::string answer =
    "StringNode(hello, IntNode(18, IntNode(9, NULL, NULL), "
    "StringNode(Air, IntNode(1, NULL, NULL), NULL)), "
    "IntNode(6, NULL, StringNode(pot, NULL, NULL)))";
    EXPECT_EQ(result, answer);
}

TEST(TestUtil, ToStringTest3) {
    ...
    std::string result = tree_util->ToString(&root);
    std::string answer = "StringNode(two, StringNode(string, IntNode(3, "
    "IntNode(2, IntNode(1, IntNode(0, NULL, NULL), NULL), NULL), NULL), NULL), "
    "IntNode(2, IntNode(9, NULL, StringNode(mouse, StringNode(coffee, NULL, "
    "StringNode(ssd, NULL, StringNode(note, "
    "StringNode(finish, NULL, NULL), NULL))), "
    "StringNode(pencil, NULL, NULL))), NULL))";
    EXPECT_EQ(result, answer);
}
