...
contract that helps enhance program reliability, even though the annotations
...
Python thus adopts a Gradual Typing paradigm that combines the advantages of
...
The concept of Gradual Typing can be illustrated with the \autoref{lst:gradualTyping}
